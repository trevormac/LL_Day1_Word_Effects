...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        printf("I can do 6 things that are pretty cool. Please pick a number between 1 and 6 and I'll show you: ");
        ...
        printf("Please give me a word and I'll convert it to an lowercase string: \n");
        ...
        printf("Please give me a number and I'll convert it to an integer: \n");
        ...
        printf("Say something and I'll Canadianize it: ");
